...
int main()
{
    ...
    num = (int) car; /* Conversion explicita que asigna 49 a la variable num (c-like notation) */
    num = int(car); /* Lo mismo pero con "functional notation"*/
    ...
    num5 = (short) nreal2; /* Conversion explicita */
    //num5 = short(nreal2); /* Conversion explicita, functional notation */
